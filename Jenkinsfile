pipeline {
  ...
  environment {
    ...
    CALCULATION_SERVICE_IMAGE = 'ganeshv2-casestudy-calculation-service'
    ECR_CREDENTIALS = credentials('ecr-credentials')
    VALIDATION_RESPONSE_DAEMON_IMAGE = 'ganeshv2-casestudy-creditcard-identity-verification-response-daemon'
    EMAIL_SERVICE_IMAGE = 'ganeshv2-casestudy-email-service'
    CREDITCARD_SERVICE_IMAGE = 'ganeshv2-casestudy-creditcard-service'
    IDENTITY_VERIFICATION_SERVICE_IMAGE = 'ganeshv2-casestudy-identity-verification-service'
  }
}
